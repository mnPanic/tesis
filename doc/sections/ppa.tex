...
implementado son contados en el \namedref{chap:ppa-certifier}, y los detalles de
...
\begin{figure}[H]
    \lstinputlisting[firstline=12,lastline=61,language=PPA]{listings/interfaz/alumnos.ppa}
...
\lstinputlisting[firstline=1,lastline=23]{listings/interfaz/alumnos.ppa}
...
\begin{figure}[H]
    \lstinputlisting[firstnumber=last,firstline=25,lastline=46]{listings/interfaz/alumnos.ppa}
\end{figure}
...
\begin{figure}[H]
    \lstinputlisting[firstnumber=last,firstline=48,lastline=61]{listings/interfaz/alumnos.ppa}
\end{figure}
