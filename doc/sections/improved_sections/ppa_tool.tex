...
% --- IMPROVEMENTS ---
% 
% 1. Improve installation instructions by including potential troubleshooting tips.
% 2. Provide better flow between examples and user guidance.
% 3. Use more concise language for command explanations.
% 