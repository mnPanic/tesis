...
\begin{itemize}
    ...
    ni chequear tipos. Se podría agregar para permitir escribir programas más
    sofisticados y con garantías estáticas más fuertes.
    ...
    fórmulas válidas. Podríamos refinarlo aún más, lo que permitiría usar
    más tipos de axiomas.
    \item \textbf{Extender traducción de Friedman a más de un existencial}: en
    su versión final, lo máximo que llega a convertir son fórmulas de la pinta
    $\forall \varTwo_1 \dots \forall \varTwo_n . \exists \var .
    \anyForm(\dots)$. Se debería poder extender a fórmulas de la pinta $\forall
...
% TODO: Tipos?
% TODO: Extender la traducción de Friedman a más de un existencial
