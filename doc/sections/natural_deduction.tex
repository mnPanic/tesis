...
\begin{ejemplo}
    ...
    Vamos a tomar los siguientes como \textit{axiomas}, que van a formar parte del contexto inicial de la demostración. Es lo mismo que haremos en PPA para modelar teorías de primer órden.
...
\subsection{Ajustes para generación de demostraciones}

\subsubsection{Hipótesis etiquetadas}
...
\subsubsection{Variables libres en contexto}
...
El algoritmo de chequeo de una demostración en deducción natural consiste en recorrer recursivamente el árbol de demostración, chequeando que todas las inferencias sean válidas. Que se usan para demostrar la fórmula que corresponde (no un \ruleAndI{} para un $\fOr$) y que cumplen con las condiciones impuestas.
