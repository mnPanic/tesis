...
\begin{ejemplo}
    ...
    \begin{itemize}
        \item \ruleImpI: \textit{introducimos} la implicación, para demostrarla, asumimos el antecedente y en base a eso demostramos el consecuente.
...
Reglas de deducción natural para lógica de primer órden:
