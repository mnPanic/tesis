...
fórmula en DNF se implementa de forma \textit{small-step}. La conversión es la
clausura de hacer un ``paso'', que puede o bien ser un paso de reescritura, o
uno de congruencia reescribiendo una sub-fórmula. En cada uno se usa una de las
