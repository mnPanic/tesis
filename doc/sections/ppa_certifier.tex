...
\begin{prop*}[Criterio de de Bruijn \cite{freek-bruijn}] Un asistente de
...
El solver implementado es \textbf{completo para lógica proposicional}, pero heurístico para lógica de primer orden.
