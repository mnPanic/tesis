...
Esto no valdrá para todas las fórmulas, lo que restringirá las axiomatizaciones. Solo para las que llamaremos \textit{F-fórmulas}
...
\begin{obs}[Similitud con fórmulas de Harrop]
    ...
    Aparentemente, la noción de F-fórmulas a la que llegamos se vincula con las fórmulas hereditarias de Harrop \cite{harrop}, definidas por la siguiente gramática:
    \begin{align*}
