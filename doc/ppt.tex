...
\begin{frame}{Curry Howard}
    \begin{itemize}
        ...
        \item Normalización de demostraciones corresponde a semántica de $\lambda$-cálculo. Puede ser más intuitivo en cálculos.
    \end{itemize}
...
\textbf{Problema}: Muy lento (demostraciones muy grandes). Estrategias alternativas:
\begin{itemize}
    \item Un paso o muchos pasos
