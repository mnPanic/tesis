...
\begin{frame}{by - El mecanismo principal de demostración}
    ...
    \begin{itemize}
        ...
        \item Demuestra \textbf{automáticamente} que la fórmula es consecuencia lógica de la justificación
...
\begin{frame}{Demostración no constructiva}
    ...
    \begin{itemize}
        ...
        \item Lógica clásica permite razonar por el absurdo, con \ruleDnegE{} $\equiv$ \ruleLEM{}
    \end{itemize}
