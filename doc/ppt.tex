...
\begin{frame}{Estrategia de extracción indirecta - Aporte principal}
    \begin{figure}
        \centering
...
\begin{frame}{Normalización}
    - evitar desvíos supérfluos (mostrar ejemplo). Simplificamos hasta que esté en forma normal
    - isomorfismo curry howard
\end{frame}

\begin{frame}{Sustituciones}
    - regla de \ruleImpE, motivar sustituciones sin captura
\end{frame}

\begin{frame}{Algoritmo de reducción}
    - estrategia original, lenta
    - estrategia gross knuth
\end{frame}

\begin{frame}{Limitaciones}
    - lenta (reinicia focos de evaluación)
    - incompleta (reglas permutativas)
\end{frame}
