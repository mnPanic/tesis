...
\begin{frame}{Certificador del by}
    ...
    \begin{enumerate}
        ...
        \item \textbf{Razonamos por el absurdo}: Asumimos negación y demostramos una contradicción ($\fFalse$)
...
\begin{frame}{Demostración no constructiva}
    ...
    \begin{itemize}
        ...
        Ejemplo: $\fNot (\form \fAnd \formTwo) \fImp \fNot \form \fOr \formTwo$ usa LEM.
    \end{itemize}
...
\quad
    ...
    \DisplayProof
\]
    Donde \[\ctxColor = \{\hypId_1: \form, \hypId_2: \formTwo \}\]
    \end{example}
    \pause
...
\begin{frame}{Conclusiones - Extracción de testigos}
    ...
    \begin{itemize}[<+->]
        ...
        \begin{itemize}
            ...
            \item \textbf{Incompleta}: no contempla \textit{reducciones permutativas}. \textit{Mejora}: Implementarlas.
            \begin{itemize}
