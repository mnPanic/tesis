...
\begin{frame}{Asistentes de demostración}
    ...
    \todo{Hablar acá de cuales son las diferencias de PPA, y cual es el hueco que buscamos cubrir!}
\end{frame}
...
\begin{frame}{¿Entonces por qué lógica clásica?}
    \begin{itemize}
        ...
        \item Herramientas como Coq las dejan afuera. Es interesante considerarlas.
        %\item Permite razonar por el absurdo $(\ruleDnegE{} \equiv \ruleLEM{})$
    \end{itemize}
\end{frame}
