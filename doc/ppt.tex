    ...
    Si la tesis es una conjunción, se puede probar un subconjunto de ella y se reduce el resto.
        ...
        \begin{column}{0.5\textwidth}
            ...
            \begin{itemize}[<+->]
                ...
                \end{gather*}
                \item Completo para proposicional $\Rightarrow$ resuelve asociatividad, conmutatividad e idempotencia (repetidos)
            \end{itemize}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Extracción indirecta con instanciación}
    \onslide<1->{\lstinputlisting[firstline=1,lastline=2]{listings/ppt/extract/forall.ppa}}\vspace*{-\baselineskip}
    \onslide<2->{\lstinputlisting[firstnumber=last,firstline=3,lastline=9]{listings/ppt/extract/forall.ppa}}\vspace*{-\baselineskip}
    \onslide<3->{\lstinputlisting[firstnumber=last,firstline=10]{listings/ppt/extract/forall.ppa}}\vspace*{-\baselineskip}
\end{frame}
